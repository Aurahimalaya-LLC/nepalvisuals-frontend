        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center relative z-10">
            ...
            <p className="text-text-secondary mb-8 leading-relaxed">
              We believe the Himalayas are not just a destination, but a legacy
              we borrow from future generations. Our commitment to sustainable
              tourism ensures that every step you take leaves a positive impact
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-text-secondary text-sm">
                    For every trekker, we plant 5 trees in deforested areas of
                    Nepal to combat soil erosion.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-text-secondary text-sm">
                    We ensure fair wages and provide education funding for the
                    children of our porters and guides.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-text-secondary text-sm">
                    Our "Carry In, Carry Out" policy ensures trails remain
                    pristine. We use reusable gear to minimize plastic.
                  </p>
                </div>
              </div>
            </div>
