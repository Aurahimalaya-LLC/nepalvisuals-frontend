...
const FeaturedDestinations = () => {
  const destinations = [
    ...
    },
    {
      ...
      price: 900,
      description:
        "Traverse the rugged landscapes of Chile and Argentina in one epic journey.",
      image:
    ...
    },
    {
      ...
      price: 1500,
      description:
        "Climb the roof of Africa through five distinct climate zones to the icy summit.",
      image:
    ...
    <section className="mb-10 md:mb-24">
      <div className="flex items-end justify-between mb-10 px-2">
        <div>
          ...
          <p className="text-text-secondary">
            Curated adventures for the brave hearted.
          </p>
        </div>
        <a
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {destinations.map((destination, index) => (
          <div
            key={index}
            className="group relative flex flex-col gap-4 p-3 bg-surface-dark rounded-[2rem] border border-white/5 hover:border-primary/30 transition-all hover:shadow-lg hover:shadow-primary/5"
          >
