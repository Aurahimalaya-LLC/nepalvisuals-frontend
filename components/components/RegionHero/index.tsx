...
const RegionHero: React.FC = () => {
  ...
  return (
    <header className="relative -mt-[50px] min-h-[75vh] md:min-h-[85vh] flex items-end justify-center overflow-hidden rounded-b-[2rem] md:rounded-b-[3rem] shadow-2xl shadow-black/50">
      {/* Background Image */}
      <div
      ...
      <div className="relative z-10 container mx-auto px-4 pb-16 pt-40 max-w-7xl">
        <div className="max-w-4xl animate-fade-in-up">
          ...
          <p className="text-lg md:text-2xl text-gray-200 font-medium max-w-2xl leading-relaxed drop-shadow-md">
            The ultimate trekking hub for adventure seekers. From the giants of
            the Everest region to the cultural trails of Annapurna, discover the
