        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-6">
              ...
              <span className="text-xs font-bold text-white uppercase tracking-wider">Community</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight tracking-tight">
              Join our tribe of <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-white">explorers</span>
            </h2>
            <p className="text-text-secondary text-lg mb-8 leading-relaxed max-w-md">
              Receive exclusive stories, gear guides, and early access to new routes directly to your inbox.
            </p>
            
            <div className="flex items-center gap-4">
              <div className="flex -space-x-4">
                <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&auto=format&fit=crop" alt="Traveler" className="w-12 h-12 rounded-full border-4 border-surface-dark object-cover" />
                <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&h=100&auto=format&fit=crop" alt="Traveler" className="w-12 h-12 rounded-full border-4 border-surface-dark object-cover" />
              ...
              <div className="text-sm">
                ...
                <p className="text-text-secondary text-xs">No spam, just adventure.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-darker/50 backdrop-blur-sm border border-white/5 p-8 rounded-3xl shadow-xl">
            <form className="flex flex-col gap-4" >
              <div>
                <label htmlFor="newsletter-email" className="block text-sm font-bold text-white mb-2 ml-1">Email Address</label>
