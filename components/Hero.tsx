  ...
  return (
    <header className="relative -mt-[100px] min-h-[85vh] flex items-center justify-center overflow-hidden rounded-b-2xl md:rounded-b-[3rem]">
      ...
      <div className="relative z-10 container mx-auto px-4 pt-32 text-center max-w-5xl ">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary/30 border border-white/20 backdrop-blur-sm mb-3 md:mb-6 mt-15 md:mt-0">
        ...
        <h1 className="text-4xl md:text-7xl lg:text-8xl font-black text-white tracking-tight leading-[1.1] mb-3 md:mb-6 drop-shadow-lg">
          Conquer the <br />
        ...
        <p className="text-sm md:text-xl text-gray-100 max-w-2xl mx-auto mb-10 font-medium drop-shadow-md">
          Professional guides, unforgettable trails, and the adventure of a
          lifetime waiting just beyond the horizon.
        </p>
            ...
            <form className="flex flex-col md:flex-row gap-2">
              ...
              <div className="relative md:w-[220px] group">
                ...
                <select className="w-full h-16 bg-surface-darker/60 border border-white/5 rounded-[1.5rem] pl-14 pr-10 text-white placeholder-text-secondary focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all outline-none appearance-none cursor-pointer font-medium">
                  ...
                  <option className="bg-surface-dark" value="trekking">
                    Trekking
                  </option>
                  <option className="bg-surface-dark" value="climbing">
                    Climbing
                  </option>
                  <option className="bg-surface-dark" value="tours">
                    Tours
                  </option>
                </select>
