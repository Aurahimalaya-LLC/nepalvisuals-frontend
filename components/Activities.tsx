...
const Activities = () => {
  ...
  const activities = [
    {
      ...
      trips: 12,
      description:
        "Home to the world's highest peak and legendary Sherpa culture.",
      image:
    ...
    },
    {
      ...
      trips: 8,
      description:
        "Diverse terrain ranging from subtropical forests to high-altitude deserts.",
      image:
    ...
    },
    {
      ...
      trips: 5,
      description:
        "Experience the unspoiled beauty around the Spirit Mountain.",
      image:
    ...
    },
    {
      ...
      trips: 6,
      description:
        "The closest Himalayan region to Kathmandu with rich Tamang heritage.",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDRhAgmyafMtZInsKcZjC6PERny9fQkTYXnQc2xe3Dn2hSTQ2D2bEPyiLHkfuqDOIamvdyHiV6lOBJgYm_mzEkiQeGcxj6XcjWqapph7IcKty8Mcbs7CdDGengbgwALm5rAVVQmydirCKo5JLlaeh-L3z0AJYecOSmxkI8TpR7pMITU12XLou8iXgEwQe7_3NbQK8rZDzw39TV_j5JnhmpBQ55T2U0LJGQROBZEKe8IxNVO4-xOcOfSMr99VgNtWGMAriy0J_zOV2il",
    },
    {
      ...
      trips: 4,
      description:
        "A mystical kingdom beyond the Himalayas with Tibetan culture.",
      image:
  ...
  return (
    <section className="mb-7 md:mb-24">
      {/* Reviews Section */}
      <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center justify-center mb-10 md:mb-16 px-4">
      ...
      <div className="flex items-end justify-between mb-10 px-2">
        <div>
          ...
          <p className="text-text-secondary">
            Explore diverse landscapes and find your perfect trail.
          </p>
        </div>
      ...
      <div className="flex overflow-x-auto gap-6 pb-6 no-scrollbar snap-x snap-mandatory">
        {activities.map((activity, index) => (
          <div
            ...
            onClick={() =>
              router.push(`/${activity.name.toLowerCase().replace(/ /g, "-")}`)
            }
          >
