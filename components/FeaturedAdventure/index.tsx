...
const FeaturedAdventures: React.FC = () => {
  ...
  const IMG_MUSTANG =
    "https://lh3.googleusercontent.com/aida-public/AB6AXuB5MvfLhFzFM4I4GsHXx4-NVj58cLSQIVtfK7M37DQio0H8CPBdPCtvfWnnGcKSm4cCxax8DU8ngEWgHK-zekNkQZr-T4rsRU149T3vhS4xP4Fzu1IZzryaddXmwKMulICERdE4MqDNDZ6tbdffDsvn6E_GWEUogvFPQ3MT8iaOiVlCmkrWlb1SkSXylmy4ax0twHtDND9YifM2DQorAsSmHEmOLxTMcclbE5u8wOpaTOW1JUPbuQ1LdQXYDxAL3GaeYT_4lhNq51RO";
  ...
  const ADVENTURES = [
    {
      ...
      originalPrice: 1450,
      description:
        "The classic route to the base of the world's highest mountain. Experience Sherpa culture and stand face-to-face with the Khumbu Icefall.",
      image: IMG_EVEREST,
      days: 14,
    ...
    },
    {
      ...
      price: 1150,
      description:
        "A legendary trek circling the Annapurna massif. Experience diverse landscapes from subtropical jungles to high-altitude deserts at Thorong La Pass.",
      image: IMG_ANNAPURNA,
      days: 16,
      difficulty: "Moderate",
      maxAltitude: 5416,
    ...
    },
    {
      ...
      price: 1650,
      description:
        "The new classic. A restricted area trek that offers pristine culture, stunning views of Mount Manaslu, and the dramatic Larkya La Pass.",
      image: IMG_ANNAPURNA,
      days: 15,
    ...
    },
    {
      ...
      price: 850,
      description:
        "Known as the valley of glaciers, this is a beautiful short trek easily accessible from Kathmandu, offering Tamang culture and great views.",
      image: IMG_LANGTANG,
      days: 9,
      difficulty: "Easy",
      maxAltitude: 4984,
    ...
    },
    {
      ...
      price: 1850,
      description:
        "Journey to the last forbidden kingdom. Explore ancient caves, monasteries, and the walled city of Lo Manthang in this unique trans-Himalayan landscape.",
      image: IMG_MUSTANG,
      days: 17,
      difficulty: "Moderate",
      maxAltitude: 3840,
    ...
    },
    {
      ...
      price: 2100,
      description:
        "Combine the classic EBC trek with a summit of Island Peak (6,189m). A perfect introduction to Himalayan mountaineering requiring basic climbing skills.",
  ...
  const filteredAdventures = useMemo(() => {
    ...
    if (filterDuration) {
      if (filterDuration === "short") result = result.filter((a) => a.days < 7);
        ...
        result = result.filter((a) => a.days >= 7 && a.days <= 14);
      else if (filterDuration === "long")
        result = result.filter((a) => a.days > 14);
    }

    if (filterDifficulty) {
      result = result.filter(
        (a) => a.difficulty.toLowerCase() === filterDifficulty
      );
    }
  ...
  return (
    <section
      id="destinations"
      className="py-10 md:py-20 border-t border-white/5"
    >
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-text-secondary">
            Curated experiences from across the country.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 justify-between items-center p-2">
          ...
          <div className="flex items-center gap-3 w-full lg:w-auto pt-4 mt-2 lg:pt-0 lg:mt-0 border-t border-white/5 lg:border-0 lg:pl-6 lg:border-l lg:border-white/10">
            ...
            <div className="relative flex-1 lg:min-w-[180px] group">
              ...
              >
                <option className="bg-background-dark" value="popularity">
                  Most Popular
                </option>
                <option className="bg-background-dark" value="price_asc">
                  Price: Low to High
                </option>
                <option className="bg-background-dark" value="price_desc">
                  Price: High to Low
                </option>
              </select>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredAdventures.map((adventure) => (
          <div
            ...
            onClick={() =>
              router.push(
                `tour/${adventure.name.toLowerCase().replace(/ /g, "-")}`
              )
            }
            className="group flex flex-col bg-surface-dark rounded-[2rem] border border-white/5 overflow-hidden hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300"
          >
            {/* Image */}
            <div className="relative h-64 overflow-hidden">
              {adventure.tags && adventure.tags.length > 0 && (
                <div
                  className={`absolute top-4 right-4 z-10 px-3 py-1 rounded-full text-xs font-bold text-white border border-white/10 flex items-center gap-1 shadow-lg backdrop-blur-md ${
                    adventure.tags.includes("Premium")
                      ? "bg-secondary/90"
                      : adventure.tags.includes("Best Seller")
                      ? "bg-black/60"
                      : "bg-primary/90"
                  }`}
                >
